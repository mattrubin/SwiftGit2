	...
	override func spec() {
		describe("Tree.Entry(attributes:object:name:)") {
			it("should set its properties") {
				...
				let object = AnyPointer.blob(OID(string: "41078396f5187daed5f673e4a13b185bbad71fba")!)
				let name = "README.md"
		...
		describe("Tree.Entry(pointer)") {
			it("should set its properties") {
				...
				expect(entry.object).to(equal(AnyPointer.blob(OID(string: "41078396f5187daed5f673e4a13b185bbad71fba")!)))
			...
			it("should initialize its properties") {
				...
				let entries = [
					"README.md": Tree.Entry(attributes: Int32(GIT_FILEMODE_BLOB.rawValue),
					                        object: AnyPointer.blob(OID(string: "41078396f5187daed5f673e4a13b185bbad71fba")!),
					                        name: "README.md"),
				]
	...
	override func spec() {
		describe("Tag(pointer)") {
			it("should set its properties") {
				...
				expect(tag.target).to(equal(AnyPointer.commit(OID(string: "dc220a3f0c22920dab86d4a8d3a3cb7e69d6205a")!)))
